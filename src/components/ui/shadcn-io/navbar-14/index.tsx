      ...
      >
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <div className="justify-items-center flex-1">
            ...
            />
            <div className="text-muted-foreground/80 left-3 pointer-events-none absolute inset-y-0 start-0 flex items-center justify-center ps-2 peer-disabled:opacity-50">
              <SearchIcon size={16} />
            </div>
          </div>
          {/* Right side */}
